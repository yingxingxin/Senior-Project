...
export default async function OnboardingWelcomePage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-gray-900 to-black dark:from-gray-950 dark:to-black">
      ...
      <div className="relative flex min-h-screen items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="w-full max-w-5xl">
          {/* Main content card */}
          <div className="overflow-hidden rounded-3xl border border-border bg-card/80 shadow-[0_35px_120px_rgba(56,189,248,0.25)] backdrop-blur-3xl">
            <div className="relative">
              ...
              <div className="p-8 lg:p-12">
                <p className="max-w-3xl text-lg leading-relaxed text-foreground/90 lg:text-xl">
